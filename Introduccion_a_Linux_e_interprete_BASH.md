...
Ahora sí, una vez adentro de la máquina virtual verán un entorno gráfico de Lubuntu similar al de cualquier sistema operativo. El en los TP susaremos una interfaz Unix para interactuar con el mismo, esta interfaz es un intérprete de comandos de texto, llamada BASH (Bourne Again Shell). 
